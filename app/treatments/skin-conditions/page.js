...
const treatmentData = {
  ...
  icon: Scissors,
  subtitle: 'Diagnosis-Led Care for Healthier Skin',
  description:
    'Skin infections, rashes, allergies and chronic conditions deserve a diagnosis before a treatment plan.',
  ...
  credentials: [
    ...
    { label: 'Personalised Skin Plans', icon: ShieldCheck },
  ],
}
...
const skinConditions = [
  {
    title: 'Eczema',
    icon: Target,
    href: '/treatments/skin-conditions/Eczema',
    image: '/images/treatments/skin-conditions/Eczema.jpg',
    summary: 'Dermatologist-led care for dry, itchy and inflamed skin.',
    accent: 'from-[#FFF5F8] to-[#FCE8F2]',
  },
  {
    title: 'Psoriasis',
    icon: Scissors,
    href: '/treatments/skin-conditions/Psoriasis',
    image: '/images/treatments/skin-conditions/Psoriasis.jpg',
    summary: 'Personalised management for scaling, redness and recurring flare-ups.',
    accent: 'from-[#F0F7FF] to-[#E4F1FF]',
  },
  {
    title: 'Vitiligo',
    icon: Sparkles,
    href: '/treatments/skin-conditions/Vitiligo',
    image: '/images/treatments/skin-conditions/Vitiligo.jpg',
    summary: 'A careful treatment plan for patches of pigment loss.',
    accent: 'from-[#F3F8F3] to-[#E4F4E7]',
  },
  {
    title: 'Fungal Infections',
    icon: Droplets,
    href: '/treatments/skin-conditions/Fungal-Infections',
    image: '/images/treatments/skin-conditions/Fungal-Infections.jpg',
    summary: 'Targeted treatment for common skin infections, rashes and itching.',
  ...
  },
  {
    ...
    icon: Syringe,
    href: '/treatments/skin-conditions/Allergy-Management',
    image: '/images/treatments/skin-conditions/Allergy-Management.jpg',
    summary: 'Diagnosis-led care for hives, irritation and allergic reactions.',
    ...
    <main className={`${playfairDisplay.className} min-h-screen bg-white text-[#1A1A2E]`}>
      ...
      <section className="relative overflow-hidden bg-white pb-0 pt-10 lg:pt-14">
        ...
        <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
          <nav className="mb-6 flex items-center gap-1.5 text-xs font-medium text-[#5A5A72]">
            ...
            <span className="text-[#1A1A2E]">Skin Conditions</span>
          </nav>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2, ease: 'easeOut' }} className="relative">
              <div className="overflow-hidden rounded-2xl bg-[#F7F9FC] shadow-xl ring-1 ring-[#F0F2F5]">
                <ImageCard
                  ...
                  alt="Skin condition consultation"
              ...
              <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8, duration: 0.5 }} className="absolute -bottom-4 -right-4 rounded-xl bg-white px-4 py-3 shadow-lg ring-1 ring-[#F0F2F5]">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-[#1A1A2E]">Expert Medical Care</span>
                </div>
              </motion.div>
            </motion.div>
          </div>
      ...
      <section className="bg-[#FAFBFD] py-16">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.1 }} variants={fadeInUp} className="mx-auto mb-10 max-w-2xl text-center">
            ...
            <p className="mt-4 text-[#5A5A72]">Your treatment is selected around the diagnosis, severity and history of your skin concern.</p>
          </motion.div>
      ...
      <section className="bg-white px-5 pb-16 lg:px-8">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={fadeInUp} className="relative mx-auto max-w-4xl overflow-hidden rounded-2xl bg-[#1A1A2E] p-8 text-center md:p-12">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg font-medium leading-relaxed text-white md:text-xl">Healthy skin begins with understanding what is causing the concern. A clear diagnosis lets us choose care that is safe, realistic and built around you.</p>
      ...
      <section className="bg-white px-5 py-12 lg:px-8">
        <div className="mx-auto max-w-7xl rounded-2xl bg-[#D4146A] p-8 text-white shadow-xl shadow-[#D4146A]/20 md:p-12">
          <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
            <div><div className="flex items-center gap-3"><Clock className="h-6 w-6 text-white/80" /><span className="text-sm font-medium text-white/80">Same Day Appointment Available</span></div><h2 className="mt-3 text-2xl font-bold md:text-3xl">Ready to Care for Your Skin?</h2><p className="mt-2 max-w-lg text-sm text-white/85 md:text-base">Book a consultation and get a skin-care plan built around your concern, goals and medical history.</p></div>
